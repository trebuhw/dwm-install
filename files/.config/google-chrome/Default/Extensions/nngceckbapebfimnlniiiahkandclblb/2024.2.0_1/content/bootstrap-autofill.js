...
class CollectAutofillContentService {
    constructor(domElementVisibilityService, autofillOverlayContentService) {
        ...
        this.buildAutofillFieldItem = (element, index) => collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            const autofillField = Object.assign(Object.assign(Object.assign({}, autofillFieldBase), autofillFieldLabels), { rel: this.getPropertyOrAttribute(element, "rel"), type: elementType, value: this.getElementValue(element), checked: this.getAttributeBoolean(element, "checked"), autoCompleteType: this.getAutoCompleteAttribute(element), disabled: this.getAttributeBoolean(element, "disabled"), readonly: this.getAttributeBoolean(element, "readonly"), selectInfo: element.tagName.toLowerCase() === "select"
    ...
    getAutofillFieldMaxLength(element) {
        ...
        const elementMaxLength = elementHasMaxLengthProperty &&
            element.maxLength > -1
            ? element.maxLength
            : 999;
    ...
    queryAutofillFormAndFieldElements() {
        ...
        this.queryAllTreeWalkerNodes(document.documentElement, (node) => {
            var _a;
            if (((_a = node.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === "form") {
    ...
    isAutofillElementNodeMutated(nodes, isRemovingNodes = false) {
        ...
        for (let index = 0; index < nodes.length; index++) {
            ...
            const autofillElementNodes = this.queryAllTreeWalkerNodes(node, (walkerNode) => {
                var _a;
                return ((_a = walkerNode.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === "form" ||
